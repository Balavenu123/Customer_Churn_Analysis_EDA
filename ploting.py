...
class PLOT:
    def plots(df):
        try:
            '''The below plot shows the relation between Gender,citizen,churn.'''
            ...
            '''The below plot shows the relation between Phone service,Gender,citizen,churn.'''
            ...
            '''The below plot shows the relation between Multiplelines,Gender,churn.'''
            ...
            '''The below plot shows the relation between Internet service,sim.'''

            grouped = (df.groupby(['InternetService', 'Sim']).size().unstack(fill_value=0))
            x = np.arange(len(grouped))  # x positions
            width = 0.2  # bar width
            plt.figure(figsize=(10, 5))
            # Plot bars for each SIM
            ...
            '''The below plot shows the relation between Sim,Gender,citizen.'''
            ...
            '''The below plot shows the Services percentage.'''

            service_cols = ['OnlineSecurity','OnlineBackup','DeviceProtection','TechSupport','StreamingTV','StreamingMovies']
            plt.figure(figsize=(18, 10))
            # looping each column and creating subplot
            ...
            '''The below plot shows the relation between Contract,Sim,Gender.'''
            ...
            '''The below plot shows the relation between Paperlessbilling,Gender,churn.'''
            ...
            '''The below plot shows the relation between Payment Method,Gender,churn.'''
            ...
            '''The below plot shows the relation between Tenure,Sim,Gender,churn.'''
            ...
            '''The below plot shows the relation between Monthlycharges,Sim,churn.'''
            ...
            '''The below plot shows the relation between Region,Gender,citizen,churn.'''
            ...
            for sc in [0, 1]:
                ...
                for i, churn in enumerate(['No', 'Yes']):
                    ...
                    axes[i].set_ylabel('Number of Customers')
                    axes[i].legend(title='Gender')
                # Main title for each SeniorCitizen
